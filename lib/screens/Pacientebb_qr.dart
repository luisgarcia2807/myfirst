...
class PacienteScreenqrbb extends StatefulWidget {
  final int id_paciente;
  final int idusuario;
  const PacienteScreenqrbb({super.key, required this.id_paciente, required this.idusuario});

  @override
  State<PacienteScreenqrbb> createState() => _PacienteScreenqrbb();
}

class _PacienteScreenqrbb extends State<PacienteScreenqrbb> {
