...
class ImagenPageDoctor extends StatefulWidget {
  ...
  const ImagenPageDoctor( {super.key, required this.id_paciente,required this.nombre, required this.apellido, required this.idusuariodoc});

  @override
  State<ImagenPageDoctor> createState() => _ImagenPageDoctor();
}

class _ImagenPageDoctor extends State<ImagenPageDoctor> {
                            ...
                            child: GestureDetector(
                              onTap: () async{
                                final resultado = await Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ScanViewImagen(idPaciente: idPaciente,idusuariodoc: widget.idusuariodoc,),
                                  ),
                                );
                                if (resultado == true) {
                                  setState(() {
                            ...
                            child: GestureDetector(
                              onTap: () async {
                                final resultado = await Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => SubirPDFPageImagen(idPaciente: idPaciente,idusuariodoc: widget.idusuariodoc,),
                                  ),
                                );
