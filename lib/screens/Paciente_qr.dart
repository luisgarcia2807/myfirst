...
class PacienteScreenqr extends StatefulWidget {
  final int id_paciente;
  final int idusuario;
  const PacienteScreenqr({super.key, required this.id_paciente, required this.idusuario});

  @override
  State<PacienteScreenqr> createState() => _PacienteScreenqr();
}

class _PacienteScreenqr extends State<PacienteScreenqr> {
