...
class VistaBebe2 extends StatefulWidget {
  final int idusuario;
  const VistaBebe2({super.key, required this.idusuario, });

  @override
  State<VistaBebe2> createState() => _VistaBebe2();
}

class _VistaBebe2 extends State<VistaBebe2> {
